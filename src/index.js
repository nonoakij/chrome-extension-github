...
element.onclick = function () {
    return __awaiter(this, void 0, void 0, function () {
        var anchorElementList, text;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ExpandOmittedCommits()];
                case 1:
                    _a.sent();
                    anchorElementList = document.querySelectorAll(selector);
                    text = "";
                    anchorElementList.forEach(function (anchorElement) {
                        if (!(anchorElement instanceof HTMLAnchorElement))
                            return;
                        var link = anchorElement.href.split("https://github.com/")[1];
                        text = text.concat("<li>".concat(link, "</li>"));
                    });
...
function ExpandOmittedCommits() {
    return new Promise(function (resolve) {
        function recursivelyExpandOmittedCommits() {
            var loadMoreElem = document.querySelector("button.ajax-pagination-btn");
