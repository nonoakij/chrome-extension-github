...
element.onclick = function() {
  var text = [...document.querySelectorAll('[data-hovercard-type="pull_request"]')].reduce((all,c)=>{ var link = c.href.split('https://github.com/')[1]; return all ? `${all}<li>${link}</li>` : `<li>${link}</li>`},'');
